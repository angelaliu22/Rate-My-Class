...
class ReviewersControllerTest < ActionController::TestCase
  ...
  test "should create reviewer" do
    assert_difference('Reviewer.count') do
      post :create, reviewer: { major: @reviewer.major, password: @reviewer.password, username: @reviewer.username, year: @reviewer.year }
    end
  ...
  test "should update reviewer" do
    patch :update, id: @reviewer, reviewer: { major: @reviewer.major, password: @reviewer.password, username: @reviewer.username, year: @reviewer.year }
    assert_redirected_to reviewer_path(assigns(:reviewer))
  end
